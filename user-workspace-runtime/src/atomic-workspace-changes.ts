...
/** Apply a complete client change set in the Computer VFS SQLite transaction. */
export function applyAtomicWorkspaceChanges(workspace: Workspace, changes: readonly AtomicWorkspaceChange[]): string[] {
