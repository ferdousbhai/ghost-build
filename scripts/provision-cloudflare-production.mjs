...
function ensureD1Database(d1) {
  ...
  if (hasConfiguredId && databases.length > 0) {
    fail(`Configured D1 database_id ${configuredId} was not found in the Cloudflare account.`);
  }
...
function ensureR2Bucket(r2) {
  ...
  const createResult = runWrangler(['r2', 'bucket', 'create', bucketName], { allowFailure: true });
