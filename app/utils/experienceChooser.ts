...
/**
 * The full Ghostbuild experience doesn't work in Safari.
...
export function chooseExperience(userAgent: string, crossOriginIsolated: boolean | 'dunno' = 'dunno'): Experience {
  ...
  if (device.type === 'mobile' || device.type === 'tablet') {
    ...
    return crossOriginIsolated ? 'mobile-warning' : 'marketing-page-only-for-mobile';
  }
  ...
  // WebContainer apps do not work reliably in Safari yet.
