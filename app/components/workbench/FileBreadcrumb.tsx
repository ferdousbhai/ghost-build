...
const WORK_DIR_PARENT_PREFIX = `${WORK_DIR.split('/').slice(0, -1).join('/')}/`;

function isWorkspaceParentPath(path: string) {
  return path.startsWith(WORK_DIR_PARENT_PREFIX);
}
