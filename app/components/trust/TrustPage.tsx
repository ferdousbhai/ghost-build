...
import {
  TRUST_DOCUMENT_PROPOSED_EFFECTIVE_DATE,
  TRUST_DOCUMENT_PROPOSED_EFFECTIVE_ISO_DATE,
  TRUST_DOCUMENT_REVIEW_STATUS,
    ...
    <div className="trust-page min-h-svh">
      ...
      <div className="trust-page__layout">
        <aside className="trust-page__rail" aria-label="Document status">
          ...
          <p>Proposed effective date</p>
          <time dateTime={TRUST_DOCUMENT_PROPOSED_EFFECTIVE_ISO_DATE}>{TRUST_DOCUMENT_PROPOSED_EFFECTIVE_DATE}</time>
        </aside>
        <article className="trust-page__article">
          ...
          <div className="trust-page__notice" role="note">
            <strong>Launch approval pending.</strong> {TRUST_DOCUMENT_REVIEW_STATUS}
          </div>
