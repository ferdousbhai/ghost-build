...
export declare function decideConversationCompaction(
  input: Readonly<{
...
export declare function createConversationCompactionController<Message, Snapshot, Context = undefined>(
...
export declare function conversationCompactionKey(
  input: Readonly<{
    scope: string;
    throughId: string;
...
export declare function canApplyConversationCompaction(
  input: Readonly<{
