/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 30f2042e687cd3bc9a65f557a2472e30)
// Runtime types generated with workerd@1.20260507.1 2026-05-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GhostBuildAgent";
	}
	interface Env {
		APP_NAME: "GhostBuild";
		DEPLOYMENT_TARGET: "cloudflare-workers";
		GhostBuildAgent: DurableObjectNamespace<import("./src/worker").GhostBuildAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "DEPLOYMENT_TARGET">> {}
}
